# tgb - 2/7/2020 - Calculating statistics for the three test networks of notebook 035
...
for i,NNs in enumerate(NNarray):
    ...
    for j,data in enumerate(data_file):
        ...
        md[NNs][data[13:-3]].compute_stats()
        pickle.dump(md[NNs][data[13:-3]].stats,open(TRAINDIR+'HDF5_DATA/'+NNs+'md'+data+'.pkl','wb'))
