...
if BATCH_NORM==1:
    batch = BatchNormalization()(inp)
else:
    batch = inp
#densout = Dense(128, activation='linear')(inp)
densout = Dense(NUM_UNITS, activation='linear')(batch)
...
for i in range(NUM_LAYERS): #range (6):
    ...
    densout = LeakyReLU(alpha=LEAKY_RELU_ALPHA)(densout)
dropout = Dropout(rate=DROPOUT_RATE)(densout)
dense_out = Dense(64, activation='linear')(dropout)
