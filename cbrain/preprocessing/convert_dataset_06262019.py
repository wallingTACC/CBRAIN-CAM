...
# tgb - 6/26/2019 - Realigning the SEF because the option was run w\ fluxbypass_aqua
...
def preprocess(in_dir, in_fns, out_dir, out_fn, vars, lev_range=(0, 30)):
    ...
    logging.info('IMPORTANT: You are using a temporary version that uses surface fluxes from the same timestep')
